...
const OPTIONS: { value: Visibility; label: string; icon: React.ReactNode; desc: string }[] = [
  { value: 'public',  label: '전체 공개',  icon: <Globe className="h-4 w-4" />,  desc: '누구나 볼 수 있어요' },
  { value: 'friends', label: '친구 공개',  icon: <Users className="h-4 w-4" />,  desc: '나를 팔로우하는 사람만' },
  { value: 'private', label: '나만 보기',  icon: <Lock className="h-4 w-4" />,   desc: '나만 볼 수 있어요' },
]
